 ...
 /*8. Вывести пользователей где password 12333 -*/ 
	select * from students where password in ('12333');
 /*9. Вывести пользователей которые были созданы 2021-03-26 00:00:00 -*/ 
	select * from students  where created_on in ('2021-03-26 00:00:00');
 /*10. Вывести пользователей где в имени есть слово Анна -*/ 
	select * from students where name in ('Anna');
 /*11. Вывести пользователей где в имени в конце есть 8 -*/ 
	select * from students where name like '%8';
 /*12. Вывести пользователей где в имени в есть буква а -*/ 
	select * from students where name like '%a%';
 /*13. Вывести пользователей которые были созданы 2021-07-12 00:00:00 -*/ 
	select * from students where created_on in ('2021-07-12 00:00:00');
 ...
 /*16. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и у которых в имени есть цифра 8 -*/ 
	select * from students where created_on='2021-07-12 00:00:00' and name='%8%';
 /*17. Вывести пользователя у которых id равен 110 -*/ 
	select * from students where id in ('110');
